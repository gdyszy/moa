<template>
	<view>
		<from-item ref="item1" mode="input" itemTitle="加班事项" placeholder="请填写加班事项" @inputVal="inputVal" />
		...
		<from-item ref="item4" mode="input" itemTitle="时长(小时)" placeholder="请填写" @inputVal="hourVal" />
		<from-item ref="item5" mode="input" itemTitle="备注" placeholder="如有补充,请填写备注" @inputVal="remarksVal" />
