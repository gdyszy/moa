<template>
	<view class="uni-container">
		...
		<!-- 搜索转出选择器 -->
		<tki-tree ref="tkitree" @watchSearch="watchSearch" :range="list" :status="treeStatus" rangeKey="name"
...
import tkiTree from "@/components/tki-tree/tki-tree.vue"
	...
	export default {
		...
		data() {
			return {
				list: [], //搜索选择器数据
				treeStatus: "loading", //树组件加载状态 1，正在加载，2·暂无数据
		...
		methods: {
			...
			getDepartment(name) {
				var _this = this;
				_this.treeStatus = 'loading'; //树组件加载状态  {getTree: {}}
