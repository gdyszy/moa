...
<script>
  import { validator } from '../js_sdk/validator/survey.js';
    ...
    methods: {
      ...
      submit() {
        ...
        this.$refs.form.validate().then((res) => {
			res.update_time = Math.round(new Date())
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("name,description,status,surveytype,start_time,end_time").get().then((res) => {
