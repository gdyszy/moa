<template>
	<view class="uni-forms-item" :class="{' uni-forms-item--border-end':borderend,'uni-forms-item--border':border,'is-first-border':border&&isFirstBorder,'uni-forms-item-error':msg}">
